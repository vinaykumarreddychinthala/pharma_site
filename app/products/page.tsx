...
const categories = ['All', 'Pain Relief', 'Vitamins', 'Cold & Flu', 'Antibiotics']
      ...
      <main className="flex-1">
        ...
        <section className="bg-primary text-primary-foreground py-8">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="mt-2 text-primary-foreground/90">Browse our complete collection of medicines and health products</p>
          </div>
        </section>
